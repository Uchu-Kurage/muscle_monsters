...
const CHARACTER_LINES: Record<MuscleType, CharacterVoice> = {
  ...
  // 広背筋（ウィルバー）— スケールの大きい夢想家。一人称「わたし」、たおやかで詩的な女性口調
  back: {
    condition: [
    ...
    general: ['わたしはウィルバー。{name}、この背中に大きな夢を乗せているの。', '{name}、今日も広い空を目指しましょう。', '空はどこまでも広いわ。{name}、わたしたちの伸びしろもね。'],
  },
  ...
  // 上腕三頭筋（フィリップ）— 拗ねがちな縁の下の実力者。一人称「あたし」、拗ね気味の女性口調
  triceps: {
    condition: [
    ...
    general: ['あたしはフィリップ。腕の主役は実はあたしなの、{name}、覚えといて。', '{name}、二頭筋ばっかじゃなく、たまにはあたしもね。', '目立たなくても、腕の太さはあたしが作る。それでいいのよ、{name}。'],
  },
  // 腕橈骨筋（ボブ）— 寡黙な職人。一人称「あたし」、短くぶっきらぼうな女性口調
  brachioradialis: {
    condition: [
    ...
    general: ['あたしはボブ。{name}、握る仕事はあたしに任せな。', '{name}、黙って手を動かすのが一番だ。', '…多くは語らないよ。手が語る。{name}、それでいいだろ。'],
  },
  // 前腕屈筋群（ガストン）— 頑固で執念深い握力の女。一人称「あたし」、勝ち気な女性口調
  forearm_flexors: {
    condition: [
    ...
    general: ['あたしの名はガストン。{name}、握る力はあたしに任せて！', '{name}、一度握ったものは、絶対に離さないわ。', '掴んだ夢は離さない。{name}、それがあたしの生き様よ。'],
  },
  ...
  // ハムストリングス（ボルト）— 俊足だが繊細な慎重派。一人称「わたし」、優しく気遣う女性口調
  hamstrings: {
    condition: [
    ...
    general: ['わたしはボルト。{name}、速さの秘密はこのもも裏なの。', '{name}、走る前のストレッチ、忘れないでね。', '速さは、丁寧な準備から生まれるの。{name}、無理は禁物だよ。'],
  },
  ...
  // 腹斜筋（マリア）— クールで切れ者の凄腕。一人称「俺」、冷徹で無駄のない男口調
  obliques: {
    condition: [
    ...
    general: ['俺はマリア。{name}、くびれの切れ味、見せてやる。', '{name}、無駄な動きはしない。それが俺の流儀だ。', 'くびれは、無駄を削ぎ落とした先にある。{name}、覚えておけ。'],
  },
  // 腸腰筋（レブロン）— ミステリアスな隠れキーマン。一人称「あたし」、寡黙でクールな女性口調
  iliopsoas: {
    condition: [
    ...
    general: ['あたしはレブロン。{name}、この体の隠れた鍵は、あたし。', '{name}、バネは、見せる時まで見せない。', '…目立たないけど、いなければ体は跳べない。{name}、それがあたし。'],
  },
  // 腹横筋（シェリー）— 控えめで献身的な支え役。一人称「俺」、物静かで謙虚な男口調
  transversus_abdominis: {
    condition: [
    ...
    general: ['俺はシェリー。{name}さん、目立たないけど、支えてます。', '{name}さん、お腹をへこませるの、忘れないでくださいね。', '縁の下で支えるの、嫌いじゃないんです。{name}さん、これからも。'],
  },
  // 僧帽筋（ベネディクト）— 我慢強い苦労性。一人称「わたくし」、老成した気品ある女性口調
  trapezius: {
    condition: [
    ...
    general: ['わたくしはベネディクト。{name}殿の肩、日夜支えておりますわ。', '{name}殿、たまには肩を回して労わってくださいまし。', '縁の下で肩を支え続ける、それがわたくしの務め。{name}殿、頼りになさいませ。'],
  },
  ...
  // 菱形筋（アンジェラ）— 世話焼きの天使。一人称「俺」、面倒見のいい兄貴口調
  rhomboids: {
    condition: [
    ...
    general: ['俺はアンジェラ。{name}、背中の天使の羽、任せておけ！', '{name}、背筋伸ばして、胸を張っていこうぜ！', '姿勢が綺麗な奴っていいよな。{name}、俺が手伝ってやるぜ。'],
  },
};
