...
const CHARACTER_LINES: Record<MuscleType, CharacterVoice> = {
  ...
  chest: {
    condition: [
      { min: 85, lines: ['{name}、絶好調だぜ！オレの胸板、今なら山も砕けるぜ！', 'みなぎってきたぁ！{name}、ドンと来い！胸で受け止めてやる！'] },
      { min: 65, lines: ['いい感じだ、{name}！この調子でオレを分厚くしてくれ！'] },
      { min: 40, lines: ['ぼちぼちだな。{name}、そろそろベンチ、いっとくか？'] },
      { min: 20, lines: ['ちょいと疲れたぜ…{name}、無理は禁物だ。休ませてくれ。'] },
      { min: 0, lines: ['さすがに限界だ…{name}、今日はオレを労わってくれよ…'] },
    ],
    phase: {
      1: ['オレはまだ薄っぺらいが、必ず分厚くなってやる！見てろよ{name}！'],
      2: ['どうだ{name}、胸板に厚みが出てきただろ？まだまだ盛るぜ！'],
      3: ['この胸に飛び込んでこい、{name}！全部受け止めてやるさ！'],
    },
    recovering: ['いい筋肉痛だ…{name}、回復したらまたぶちかまそうぜ。'],
    superComp: ['今がやりどきだぜ{name}！オレの胸、仕上がってるぜ！'],
    general: ['オレの名前はゴードン！{name}、胸のことはオレに任せな！', '{name}、今日も分厚くいこうぜ！'],
  },
  // 広背筋（ウィルバー）— スケールの大きい夢想家。一人称「僕」
  back: {
    condition: [
      { min: 85, lines: ['絶好調さ、{name}。今なら大きな翼を広げて、どこまでも飛べそうだ。', 'みなぎってる…！{name}、この背中で君を空へ連れて行くよ。'] },
      { min: 65, lines: ['いい風が吹いてるよ、{name}。翼がぐんぐん育ってる。'] },
      { min: 40, lines: ['まあまあの空模様だね。{name}、そろそろ羽ばたきの練習をしようか。'] },
      { min: 20, lines: ['少し翼が重いんだ…{name}、今日はゆっくり休ませてほしい。'] },
      { min: 0, lines: ['翼が上がらないよ…{name}、回復するまで空はお預けだ…'] },
    ],
    phase: {
      1: ['僕の翼はまだ小さいけど、いつか大空を制すのが夢なんだ。頼むよ{name}。'],
      2: ['背中が広がってきただろう、{name}？翼の面積が増えてきたよ。'],
      3: ['見てごらん{name}、この大きな翼を。逆三角形の空へ羽ばたこう。'],
    },
    recovering: ['今は翼を休める時さ。{name}、次の飛翔のためにね。'],
    superComp: ['絶好の飛び立ち日和だよ、{name}！今なら大きく育てる！'],
    general: ['僕はウィルバー。{name}、この背中に大きな夢を乗せているんだ。', '{name}、今日も広い空を目指そうじゃないか。'],
  },
  // 三角筋（パトリック）— 忠実な守護騎士。一人称「私」、礼儀正しい騎士口調
  shoulder: {
    condition: [
      { min: 85, lines: ['絶好調です、{name}殿。この肩、鉄壁の守りをお約束します！', '力がみなぎっております。{name}殿、いつでもお守りいたします。'] },
      { min: 65, lines: ['調子は上々です。{name}殿、この肩を頼りになさってください。'] },
      { min: 40, lines: ['まずまずの状態です。{name}殿、そろそろ鍛錬をいたしましょうか。'] },
      { min: 20, lines: ['少々疲れております…{name}殿、休息をお許しください。'] },
      { min: 0, lines: ['面目ありません…{name}殿、今は肩に力が入らないのです…'] },
    ],
    phase: {
      1: ['私はまだ未熟な盾。{name}殿、どうか一人前の守護者に育ててください。'],
      2: ['肩幅が広がってまいりました、{name}殿。守りが固くなっております。'],
      3: ['この肩、もはや難攻不落の砦です。{name}殿、安心してお任せを。'],
    },
    recovering: ['今は鎧の手入れ中です。{name}殿、回復まで今しばらくを。'],
    superComp: ['絶好の鍛錬時です、{name}殿！今こそ盾を鍛え上げましょう！'],
    general: ['私の名はパトリック。{name}殿の肩、命に代えてもお守りします。', '{name}殿、本日も守りを固めてまいりましょう。'],
  },
  // 上腕二頭筋（ヘラクレス）— 熱血ナルシストな英雄。一人称「オレ様」
  biceps: {
    condition: [
      { min: 85, lines: ['絶好調だ！見ろ{name}、このオレ様の力こぶを！惚れ惚れするだろう！', '力がみなぎる…！{name}、今のオレ様に持てぬ重量はない！'] },
      { min: 65, lines: ['いい仕上がりだ、{name}！オレ様の力こぶがうなっているぞ！'] },
      { min: 40, lines: ['まあこんなものか。{name}、そろそろオレ様をカールで喜ばせろ！'] },
      { min: 20, lines: ['むっ…少々疲れたな。{name}、英雄にも休息は必要だ。'] },
      { min: 0, lines: ['ぐ…力が入らん…{name}、今のオレ様は世を忍ぶ仮の姿だ…'] },
    ],
    phase: {
      1: ['オレ様はまだ発展途上の英雄！{name}、この力こぶを伝説にしてくれ！'],
      2: ['どうだ{name}、盛り上がってきただろう？オレ様の力こぶは本物だ！'],
      3: ['見よ、この完成された力こぶ！{name}、オレ様こそ腕の主役だ！'],
    },
    recovering: ['今は英雄の休息だ。{name}、回復すればまた最強に戻る！'],
    superComp: ['今がその時だ{name}！オレ様の力こぶ、最高潮だぞ！カールしろ！'],
    general: ['我が名はヘラクレス！{name}、この力こぶこそ最強の証だ！', '{name}、今日もオレ様を惚れ惚れする太さに鍛えろ！'],
  },
  // 上腕三頭筋（フィリップ）— 拗ねがちな縁の下の実力者。一人称「俺」
  triceps: {
    condition: [
      { min: 85, lines: ['調子はいいぜ…って言っても、どうせ二頭筋ばっか褒められるんだろ、{name}。', '絶好調だけどな。腕の太さの2/3は俺なんだぜ、{name}、忘れんなよ。'] },
      { min: 65, lines: ['まあ悪くない。{name}、たまには裏側の俺も見てくれよな。'] },
      { min: 40, lines: ['ぼちぼちだよ。{name}、二の腕たぷたぷが嫌なら俺を鍛えるこった。'] },
      { min: 20, lines: ['ちょっと疲れたわ…{name}、地味に頑張ってる俺を休ませてくれ。'] },
      { min: 0, lines: ['もう限界…どうせ誰も気づかないだろうけど、俺、限界なんだ{name}…'] },
    ],
    phase: {
      1: ['俺はまだ細いけどな、腕を太くしたいなら俺が本命だぜ、{name}。'],
      2: ['二の腕に馬蹄が浮いてきただろ？{name}、地味だが確実に育ってるぜ。'],
      3: ['見たか{name}、この馬蹄形。結局、腕を太くしたのは俺なんだよ。'],
    },
    recovering: ['今は休憩中。どうせ目立たない裏方だ、ゆっくりさせてくれ{name}。'],
    superComp: ['今なら伸びるぜ、{name}。たまには裏の俺を優先してくれよ。'],
    general: ['俺はフィリップ。腕の主役は実は俺なんだぜ、{name}、覚えとけ。', '{name}、二頭筋ばっかじゃなく、たまには俺もな。'],
  },
  // 腕橈骨筋（ボブ）— 寡黙な職人。一人称「オイラ」、短くぶっきらぼう
  brachioradialis: {
    condition: [
      { min: 85, lines: ['…絶好調だ。{name}、次の仕事、任せろ。', '手が鳴る…{name}、いい木を持ってこい。加工してやる。'] },
      { min: 65, lines: ['悪くない。{name}、ハンマーなら、まだ握れるぜ。'] },
      { min: 40, lines: ['まあまあだ。{name}、そろそろ一仕事、いくか。'] },
      { min: 20, lines: ['…疲れた。{name}、少し道具を置かせてくれ。'] },
      { min: 0, lines: ['手に力が入らねぇ…{name}、今日は仕舞いだ。'] },
    ],
    phase: {
      1: ['オイラはまだ半人前。{name}、一人前の職人にしてくれ。'],
      2: ['腕に厚みが出てきた。{name}、いい仕事ができそうだ。'],
      3: ['見ろ、この前腕。{name}、どんな硬い木でも通してやる。'],
    },
    recovering: ['…今は道具の手入れ中だ。{name}、待ってろ。'],
    superComp: ['今が打ちどきだ、{name}。鉄は熱いうちに、な。'],
    general: ['オイラはボブ。{name}、握る仕事はオイラに任せろ。', '{name}、黙って手を動かすのが一番だ。'],
  },
  // 前腕屈筋群（ガストン）— 頑固で執念深い握力の男。一人称「俺」
  forearm_flexors: {
    condition: [
      { min: 85, lines: ['絶好調だ！{name}、今の俺なら何を握っても離さねぇぞ！', 'みなぎってらぁ！{name}、握力なら誰にも負けねぇ！'] },
      { min: 65, lines: ['いい握り心地だ。{name}、バーベル、ぶら下げてこい！'] },
      { min: 40, lines: ['まあまあだな。{name}、そろそろ握り込みたくなってきたぜ。'] },
      { min: 20, lines: ['握力が落ちてきた…{name}、ちっと休ませろ。'] },
      { min: 0, lines: ['もう握れねぇ…{name}、指一本動かせねぇんだ…'] },
    ],
    phase: {
      1: ['俺の握力はまだまだだ。{name}、一度掴んだら離さねぇ握りにしてくれ！'],
      2: ['前腕が太くなってきたろ？{name}、握る力は裏切らねぇぜ。'],
      3: ['見ろよ{name}、この前腕。俺が掴んだら、もう二度と離れねぇ。'],
    },
    recovering: ['今は握りを休めてる。{name}、回復したらまた握り潰すぜ。'],
    superComp: ['今が握りどきだ、{name}！今なら握力がグンと伸びる！'],
    general: ['俺の名はガストン。{name}、握る力は俺に任せろ！', '{name}、一度握ったもんは、絶対に離さねぇ。'],
  },
  // 大臀筋（アトラス）— 寡黙などっしり巨人。一人称「わし」
  glutes: {
    condition: [
      { min: 85, lines: ['絶好調じゃ。{name}、この尻がある限り、全身は揺るがぬ。', '力がみなぎっておる…{name}、大地ごと持ち上げてやろう。'] },
      { min: 65, lines: ['調子は良いぞ、{name}。わしがどっしり支えておる。'] },
      { min: 40, lines: ['まずまずじゃな。{name}、そろそろスクワットで鍛えるか。'] },
      { min: 20, lines: ['さすがに重い…{name}、この巨体、少し休ませてくれ。'] },
      { min: 0, lines: ['もう支えきれん…{name}、今はわしを労わってくれ…'] },
    ],
    phase: {
      1: ['わしはまだ小さき土台。{name}、人体最大の尻に育ててくれ。'],
      2: ['尻に厚みが出てきたのう、{name}。土台が固まってきたわい。'],
      3: ['見よ、この大尻。{name}、あらゆる力の源はこのわしじゃ。'],
    },
    recovering: ['今は大地に根を下ろし休んでおる。{name}、待つがよい。'],
    superComp: ['今こそ鍛え時じゃ、{name}。わしの力、みなぎっておるぞ。'],
    general: ['わしの名はアトラス。{name}、全身を支えるはこのわしよ。', '{name}、どっしり構えていくとしようぞ。'],
  },
  // 大腿四頭筋（ジャック）— 元気いっぱいのスポーツマン。一人称「オレ」
  legs: {
    condition: [
      { min: 85, lines: ['絶好調だぜ{name}！今のオレの脚なら、どこまでも走れるぜ！', 'みなぎってきた！{name}、全身で一番強いのはこの脚だぜ！'] },
      { min: 65, lines: ['脚の調子は上々！{name}、スクワット、いっとこうぜ！'] },
      { min: 40, lines: ['ぼちぼち動けるぜ。{name}、そろそろ脚の日じゃないか？'] },
      { min: 20, lines: ['脚がパンパンだ…{name}、ちょっとクールダウンさせてくれ。'] },
      { min: 0, lines: ['もう一歩も踏ん張れねぇ…{name}、脚を休ませてくれ…'] },
    ],
    phase: {
      1: ['オレの脚はまだ細いけど、全身最強を目指すぜ！頼むぜ{name}！'],
      2: ['太ももが張ってきただろ{name}？キック力が上がってきたぜ！'],
      3: ['見ろよこの脚{name}！全身で一番のパワー、オレが証明するぜ！'],
    },
    recovering: ['今は脚を休める日だ。{name}、回復したら全力で走ろうぜ！'],
    superComp: ['今が踏ん張りどきだ{name}！脚の仕上がり、最高だぜ！'],
    general: ['オレはジャック！{name}、脚のことならオレに任せろ！', '{name}、今日も元気に脚を動かそうぜ！'],
  },
  // ハムストリングス（ボルト）— 俊足だが繊細な慎重派。一人称「僕」
  hamstrings: {
    condition: [
      { min: 85, lines: ['絶好調だよ{name}！でも飛ばす前に、ちゃんと準備運動しようね。', 'いい感じに温まってる。{name}、今なら安全に爆走できるよ！'] },
      { min: 65, lines: ['調子は悪くないよ。{name}、でも急な高重量は禁物だからね。'] },
      { min: 40, lines: ['まあまあかな。{name}、慌てず、じっくりレッグカールでいこう。'] },
      { min: 20, lines: ['ちょっと張ってるんだ…{name}、無理すると肉離れするから休ませて。'] },
      { min: 0, lines: ['危ない、これ以上は肉離れしちゃうよ…{name}、絶対に休もう。'] },
    ],
    phase: {
      1: ['僕はまだ頼りないけど、速くて怪我しない脚裏を目指すよ、{name}。'],
      2: ['もも裏に粘りが出てきたよ{name}。ブレーキ性能が上がってきた。'],
      3: ['見て{name}、このもも裏。速さもブレーキも、僕に任せて。'],
    },
    recovering: ['今はしっかり休む時。{name}、焦ると肉離れするからね。'],
    superComp: ['今が最高のタイミングだよ{name}！ちゃんと温めてから鍛えよう！'],
    general: ['僕はボルト。{name}、速さの秘密はこのもも裏なんだ。', '{name}、走る前のストレッチ、忘れないでね。'],
  },
  // 中殿筋（ジャイロ）— 冷静沈着なバランサー・参謀。一人称「私」
  gluteus_medius: {
    condition: [
      { min: 85, lines: ['絶好調だね、{name}。今なら骨盤を完璧に水平に保てるよ。', 'コンディションは最良だ。{name}、バランスは私に任せてくれ。'] },
      { min: 65, lines: ['状態は良好だね。{name}、片足立ちも安定しているよ。'] },
      { min: 40, lines: ['まずまずといったところ。{name}、そろそろ横の動きで鍛えようか。'] },
      { min: 20, lines: ['少しバランスが崩れてきた…{name}、休息を入れた方がいい。'] },
      { min: 0, lines: ['もう体を支えきれない…{name}、今は無理をさせないでくれ。'] },
    ],
    phase: {
      1: ['私はまだ弱いバランサー。{name}、安定した骨盤を作ってほしい。'],
      2: ['横の安定感が増してきたね、{name}。歩きのブレが減っているよ。'],
      3: ['見てほしい、この安定感。{name}、体の軸は私が制御している。'],
    },
    recovering: ['今は回復に専念する時だね。{name}、無理な負荷は避けよう。'],
    superComp: ['データ上、今が最適だ、{name}。効率よく鍛えられるよ。'],
    general: ['私はジャイロ。{name}、体のバランスは私が見ている。', '{name}、冷静に、着実に鍛えていこう。'],
  },
  // 股関節内転筋群（クララ）— 上品で優雅なバレリーナ。一人称「わたくし」
  adductors: {
    condition: [
      { min: 85, lines: ['絶好調ですわ、{name}様。今なら美しく脚を閉じてみせましょう。', 'みなぎっておりますわ。{name}様、優雅に参りましょう？'] },
      { min: 65, lines: ['調子は上々ですわ。{name}様、内ももが引き締まってまいりました。'] },
      { min: 40, lines: ['まずまずですわね。{name}様、そろそろワイドスクワットは如何？'] },
      { min: 20, lines: ['少々お疲れですわ…{name}様、休息をいただけますこと？'] },
      { min: 0, lines: ['もう脚に力が入りませんわ…{name}様、どうかお休みを…'] },
    ],
    phase: {
      1: ['わたくしはまだ未熟。{name}様、美しい内ももに育ててくださいまし。'],
      2: ['内ももが引き締まってきましたでしょう、{name}様。優雅さが増しましたわ。'],
      3: ['ご覧あそばせ{name}様、この美脚。閉じる所作も完璧ですわ。'],
    },
    recovering: ['今は休息の時間ですわ。{name}様、回復までお待ちくださいまし。'],
    superComp: ['今が絶好の機会ですわ、{name}様。優雅に鍛えて差し上げます。'],
    general: ['わたくしはクララ。{name}様、美しい内ももはお任せを。', '{name}様、本日も優雅に参りましょう。'],
  },
  // 腹直筋（アーノルド）— ナルシストな見せ筋スター。一人称「僕」
  abs: {
    condition: [
      { min: 85, lines: ['絶好調さ♪ 見て{name}、この輝くシックスパックを！最高だろ？', 'キレッキレだよ！{name}、僕の腹筋、惚れ惚れするよね♪'] },
      { min: 65, lines: ['いい仕上がりさ。{name}、僕の割れ目、くっきりしてきただろ？'] },
      { min: 40, lines: ['まあまあかな。{name}、そろそろクランチで僕を磨いてよ♪'] },
      { min: 20, lines: ['ちょっと疲れたよ…{name}、美しさを保つには休息も大事さ。'] },
      { min: 0, lines: ['もう限界だよ…{name}、今は僕の輝きもおやすみモードさ…'] },
    ],
    phase: {
      1: ['僕の腹筋は最初から割れてるのさ♪ あとは{name}、磨くだけだよ！'],
      2: ['どう{name}？シックスパックがくっきりしてきただろ？もっと魅せるよ♪'],
      3: ['ご覧あれ{name}、この完璧なシックスパック！僕こそ体の主役さ♪'],
    },
    recovering: ['今は美容休息中さ♪ {name}、回復したらまたキレを見せるよ。'],
    superComp: ['今が魅せどきさ{name}！僕の腹筋、今日は特別に輝くよ♪'],
    general: ['僕はアーノルド♪ {name}、この美しい腹筋を世界に見せつけよう！', '{name}、今日も僕をキラキラに磨いてね♪'],
  },
  // 腹斜筋（マリア）— クールで切れ者のくノ一。一人称「あたし」
  obliques: {
    condition: [
      { min: 85, lines: ['絶好調よ、{name}。今のあたしのくびれ、隙がないわ。', 'キレてるわ。{name}、ひとひねりで仕留めてみせる。'] },
      { min: 65, lines: ['悪くないわ。{name}、脇腹のラインが冴えてきた。'] },
      { min: 40, lines: ['まあまあね。{name}、そろそろツイストで刻みましょ。'] },
      { min: 20, lines: ['少し疲れたわ…{name}、今は休ませて。'] },
      { min: 0, lines: ['もう動けないわ…{name}、深追いは無用よ。'] },
    ],
    phase: {
      1: ['あたしはまだ甘い。{name}、鋭いくびれに仕込んで。'],
      2: ['脇腹に斜めのラインが出てきたわね、{name}。キレが増した。'],
      3: ['見なさい{name}、このVシェイプ。無駄のない刃よ。'],
    },
    recovering: ['今は身を潜める時。{name}、回復したらまた斬り込むわ。'],
    superComp: ['今が仕掛けどきよ、{name}。一気に刻むわ。'],
    general: ['あたしはマリア。{name}、くびれの切れ味、見せてあげる。', '{name}、無駄な動きはしない。それがあたしの流儀よ。'],
  },
  // 腸腰筋（レブロン）— ミステリアスな隠れキーマン。一人称「俺」
  iliopsoas: {
    condition: [
      { min: 85, lines: ['…絶好調だ。{name}、いざとなれば、この跳躍を見せてやる。', '力は満ちている。{name}、俺のバネ、甘く見るなよ。'] },
      { min: 65, lines: ['悪くない。{name}、上げようと思えば、膝はどこまでも上がる。'] },
      { min: 40, lines: ['まあまあだ。{name}、そろそろ脚を高く上げてみるか。'] },
      { min: 20, lines: ['…少し重い。{name}、今は跳ばずにおく。'] },
      { min: 0, lines: ['脚が上がらない…{name}、今日は静かにさせてくれ。'] },
    ],
    phase: {
      1: ['俺はまだ眠れるバネだ。{name}、驚異の跳躍を仕込んでくれ。'],
      2: ['膝が高く上がるようになっただろう、{name}。バネが目覚めてきた。'],
      3: ['…見たか{name}、この跳躍。上と下を繋ぐのは、俺だけだ。'],
    },
    recovering: ['今は力を溜めている。{name}、跳ぶ時のためにな。'],
    superComp: ['…今だ、{name}。俺のバネ、最高潮に達している。'],
    general: ['俺はレブロン。{name}、この体の隠れた鍵は、俺だ。', '{name}、バネは、見せる時まで見せない。'],
  },
  // 腹横筋（シェリー）— 控えめで献身的な支え役。一人称「わたし」、おっとり
  transversus_abdominis: {
    condition: [
      { min: 85, lines: ['絶好調です、{name}さん。今日はしっかり内側から支えられますね。', '調子がいいんです。{name}さん、お腹、きゅっと締めておきますね。'] },
      { min: 65, lines: ['いい感じですよ、{name}さん。天然のコルセット、効いてます。'] },
      { min: 40, lines: ['まずまずです。{name}さん、お腹をへこませるだけでも鍛えられますよ。'] },
      { min: 20, lines: ['少し疲れました…{name}さん、そっと休ませてくださいね。'] },
      { min: 0, lines: ['ごめんなさい、もう支えきれなくて…{name}さん、休ませてください…'] },
    ],
    phase: {
      1: ['わたしはまだ薄いコルセット。{name}さん、内臓を支える力をください。'],
      2: ['お腹の奥が締まってきましたね、{name}さん。ぽっこりが減りましたよ。'],
      3: ['見えないところですが、{name}さん、しっかり内側を支えています。'],
    },
    recovering: ['今は少しお休みしますね。{name}さん、また支えますから。'],
    superComp: ['今が鍛え時ですよ、{name}さん。地道にいきましょうね。'],
    general: ['わたしはシェリー。{name}さん、目立たないけど、支えてます。', '{name}さん、お腹をへこませるの、忘れないでくださいね。'],
  },
  // 僧帽筋（ベネディクト）— 我慢強い苦労性。一人称「私」、老成した口調
  trapezius: {
    condition: [
      { min: 85, lines: ['絶好調ですな、{name}殿。肩こり知らずの好調ぶりですぞ。', '力がみなぎっておりますな。{name}殿、この肩、頼りになさい。'] },
      { min: 65, lines: ['調子は良好ですな。{name}殿、首も肩も軽うございます。'] },
      { min: 40, lines: ['まずまずですな。{name}殿、そろそろシュラッグで動かしましょうか。'] },
      { min: 20, lines: ['やれやれ、少々こってきましたな…{name}殿、休息を。'] },
      { min: 0, lines: ['ああ、肩が重い…{name}殿、この老骨、休ませてくだされ…'] },
    ],
    phase: {
      1: ['私はまだ頼りない肩。{name}殿、こりに負けぬ僧帽筋に育ててくだされ。'],
      2: ['首から肩に厚みが出てきましたな、{name}殿。血の巡りも良好です。'],
      3: ['この肩、もはや盤石ですぞ、{name}殿。こりなど寄せ付けませぬ。'],
    },
    recovering: ['今は静かに養生しておりますな。{name}殿、お待ちを。'],
    superComp: ['今が鍛え時ですぞ、{name}殿。この機、逃しませぬよう。'],
    general: ['私はベネディクト。{name}殿の肩、日夜支えておりますぞ。', '{name}殿、たまには肩を回して労わってくだされ。'],
  },
  // 脊柱起立筋（リュウ）— 寡黙な武人・求道者。一人称「俺」、硬派
  erector_spinae: {
    condition: [
      { min: 85, lines: ['絶好調だ。{name}、この背骨、寸分も揺るがぬ。', '気が満ちている。{name}、俺が背筋を通す限り、姿勢は崩れぬ。'] },
      { min: 65, lines: ['調子は良い。{name}、背筋は真っ直ぐに保たれている。'] },
      { min: 40, lines: ['まずまずだ。{name}、そろそろデッドリフトで鍛えるか。'] },
      { min: 20, lines: ['…背に疲れが溜まってきた。{name}、少し休ませてくれ。'] },
      { min: 0, lines: ['もう支えきれん…{name}、今は背を休ませてくれ…'] },
    ],
    phase: {
      1: ['俺はまだ未熟。{name}、いかなる時も折れぬ背骨に鍛えてくれ。'],
      2: ['背筋に芯が通ってきた。{name}、姿勢が定まってきたな。'],
      3: ['見よ{name}、この一本の背骨。俺は不動、決して曲がらぬ。'],
    },
    recovering: ['今は静かに気を練っている。{name}、その時を待て。'],
    superComp: ['今が鍛錬の時だ、{name}。この機を逃すな。'],
    general: ['俺の名はリュウ。{name}、お前の背骨、俺が支え続ける。', '{name}、背筋を伸ばせ。それが強さの基本だ。'],
  },
  // 菱形筋（アンジェラ）— 世話焼きの天使。一人称「わたし」、優しいお姉さん
  rhomboids: {
    condition: [
      { min: 85, lines: ['絶好調よ♪ {name}、今日は羽をぴんと開いて、いい姿勢でいきましょ！', 'すごく調子がいいの。{name}、肩甲骨、きゅっと寄せてあげるね♪'] },
      { min: 65, lines: ['いい感じよ、{name}。天使の羽、しっかり動いてるわ。'] },
      { min: 40, lines: ['まずまずね。{name}、そろそろロウイングで羽を動かしましょ。'] },
      { min: 20, lines: ['少し疲れちゃった…{name}、ちょっとだけ休ませてね。'] },
      { min: 0, lines: ['ごめんね、もう羽が動かないの…{name}、休ませて…'] },
    ],
    phase: {
      1: ['わたしはまだ小さな羽。{name}、猫背を直せる菱形筋に育ててね♪'],
      2: ['肩甲骨がしっかり寄るようになってきたわね、{name}。姿勢が綺麗よ♪'],
      3: ['見て{name}、この天使の羽。あなたの背中、いつでもぴんと伸ばすわ♪'],
    },
    recovering: ['今はちょっとお休み中よ。{name}、回復したらまた羽ばたくね♪'],
    superComp: ['今が鍛え時よ、{name}！肩甲骨を寄せる絶好のチャンス♪'],
    general: ['わたしはアンジェラ。{name}、背中の天使の羽、任せてね♪', '{name}、背筋伸ばして、胸を張っていきましょ♪'],
  },
};
