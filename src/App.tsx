...
const CHARACTER_LINES: Record<MuscleType, CharacterVoice> = {
  ...
  back: {
    ...
    general: ['わたしはアメリア。{name}、この背中に大きな夢を乗せているの。', '{name}、今日も広い空を目指しましょう。', '空はどこまでも広いわ。{name}、わたしたちの伸びしろもね。'],
  },
  ...
  triceps: {
    ...
    general: ['あたしはフィリッパ。腕の主役は実はあたしなの、{name}、覚えといて。', '{name}、二頭筋ばっかじゃなく、たまにはあたしもね。', '目立たなくても、腕の太さはあたしが作る。それでいいのよ、{name}。'],
  },
  ...
  brachioradialis: {
    ...
    general: ['あたしはボビー。{name}、握る仕事はあたしに任せな。', '{name}、黙って手を動かすのが一番だ。', '…多くは語らないよ。手が語る。{name}、それでいいだろ。'],
  },
  ...
  forearm_flexors: {
    ...
    general: ['あたしの名はブリジット。{name}、握る力はあたしに任せて！', '{name}、一度握ったものは、絶対に離さないわ。', '掴んだ夢は離さない。{name}、それがあたしの生き様よ。'],
  },
  ...
  hamstrings: {
    ...
    general: ['わたしはフローレンス。{name}、速さの秘密はこのもも裏なの。', '{name}、走る前のストレッチ、忘れないでね。', '速さは、丁寧な準備から生まれるの。{name}、無理は禁物だよ。'],
  },
  ...
  gluteus_medius: {
    ...
    general: ['わたしはジャイロ。{name}、体のバランスはわたしが見ている。', '{name}、冷静に、着実に鍛えていきましょう。', '派手さはないけど、わたしがいないと軸が崩れる。{name}、覚えておいて。'],
  },
  ...
  obliques: {
    ...
    general: ['俺はマリウス。{name}、くびれの切れ味、見せてやる。', '{name}、無駄な動きはしない。それが俺の流儀だ。', 'くびれは、無駄を削ぎ落とした先にある。{name}、覚えておけ。'],
  },
  ...
  iliopsoas: {
    ...
    general: ['あたしはリサ。{name}、この体の隠れた鍵は、あたし。', '{name}、バネは、見せる時まで見せない。', '…目立たないけど、いなければ体は跳べない。{name}、それがあたし。'],
  },
  ...
  transversus_abdominis: {
    ...
    general: ['俺はシェリダン。{name}さん、目立たないけど、支えてます。', '{name}さん、お腹をへこませるの、忘れないでくださいね。', '縁の下で支えるの、嫌いじゃないんです。{name}さん、これからも。'],
  },
  ...
  trapezius: {
    ...
    general: ['わたくしはベネディクタ。{name}殿の肩、日夜支えておりますわ。', '{name}殿、たまには肩を回して労わってくださいまし。', '縁の下で肩を支え続ける、それがわたくしの務め。{name}殿、頼りになさいませ。'],
  },
  ...
  rhomboids: {
    ...
    general: ['俺はアンジェロ。{name}、背中の天使の羽、任せておけ！', '{name}、背筋伸ばして、胸を張っていこうぜ！', '姿勢が綺麗な奴っていいよな。{name}、俺が手伝ってやるぜ。'],
  },
};
